...
/**
 * @fileOverview Centralized blog and service data for House of Petals with Swahili touch.
 */
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    title: 'Arusi ya Ndoto: The Best in Luxury Weddings',
    slogan: 'Tunaweka Upendo Kwenye Kila Ua.',
    category: 'Weddings',
    image: 'forever-yours',
    excerpt: 'From architectural floral arches to bespoke bridal bouquets, we transform venues into a "Garden of Eden" right here in Nairobi.',
  ...
  },
  {
    ...
    title: 'Siku Yako, Furaha Yetu: Ultimate Birthday Surprises',
    slogan: 'Mawazo Mapya ya Sherehe. Make it Unforgettable.',
    category: 'Surprises',
    image: 'deluxe-pink-bouquet',
    excerpt: 'Learn why our "Secret Delivery" service is the most talked-about birthday gesture in the city. Surprise zile zitapendwa!',
  ...
  },
  {
    ...
    title: 'Mapenzi ya Milele: Anniversary Collections',
    slogan: 'Maua Yetu, Mapenzi Yako. Pure Luxury Romance.',
    category: 'Anniversaries',
    image: 'heart-arrangement',
    excerpt: 'Redefining the classic red rose for your most precious milestones. Heshima kwa mpenzi wako.',
  ...
  },
  {
    ...
    title: 'Kazi Safi: Corporate Galas & Brand Design',
    slogan: 'Professionalism Sourced from Naivasha.',
    category: 'Events',
    image: 'all-white-box-boquet',
    excerpt: 'Elevate your brand with floral decor that matches your prestige. Let your brand bloom in Nairobi.',
  ...
  },
  {
    ...
    title: 'Baraka za Maua: Sacred Church Decor',
    slogan: 'Spiritual Serenity through Timeless Artistry.',
    category: 'Church',
    image: 'blooming-lillies',
    excerpt: 'Bringing spiritual serenity to your place of worship through timeless floral arrangements. Utulivu wa kiroho.',
  ...
  },
  {
    ...
    title: 'Pole Sana: Respectful Sympathy Tributes',
    slogan: 'Heshima ya Mwisho. Expressing What Words Cannot.',
    category: 'Sympathy',
    image: 'sassy-white',
  ...
  },
  {
    ...
    title: 'Sherehe Kabambe: The Art of the Party',
    slogan: 'Your Social Gathering, Reimagined.',
    category: 'Parties',
    image: 'standard-mixed-boquet',
    excerpt: 'From baby showers to graduation parties, we make every Nairobi social gathering Instagram-worthy.',
  ...
  },
  {
    ...
    title: 'Kutoka Naivasha Mpaka Nairobi',
    slogan: 'The Journey of Excellence: Farm to Vase.',
    category: 'Sourcing',
    image: 'sunkissed-vase-roses',
    excerpt: 'Go behind the scenes and see why our high-altitude flowers are the best in Kenya. Freshness halisi.',
