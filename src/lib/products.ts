...
export const ALL_PRODUCTS: Product[] = [
  ...
  { id: '37', name: 'Premium box package and lindth chocolate combo', price: 8000, image: 'premium-box-lindt-combo', category: 'Gifts', description: "A high-end gift set featuring our signature box arrangement and world-famous Lindt chocolates." },
  { id: '38', name: 'Heart box boquet and lindth chocolate combo', price: 6500, image: 'heart-box-lindt-combo', category: 'Gifts', description: "The ultimate romantic gesture. A heart-shaped box of blooms paired with decadent chocolates." },
  { id: '39', name: 'Lilies and chrysanthemums mix boquet', price: 6000, image: 'lilies-chrysanthemums-mix', category: 'Flowers', description: "The bouquet comprises of Lilies, yellow, lollipop and purple chrysanthemums perfect for expressing warmth and affection." },
  { id: '40', name: 'Pinky white and walker chocolate', price: 4200, image: 'pinky-white-walker-chocolate', category: 'Gifts', description: "Surprise someone special with the enchanting bouquet of soft pink and white roses with a touch of baby's breath and premium Walker chocolate." },
  { id: '41', name: 'Rozzy mix', price: 3700, image: 'rozzy-mix', category: 'Flowers', description: "Stunning mixed bouquet of yellow, white and purple roses that brighten any occasion with fresh and heartfelt touch." },
  ...
  { id: '43', name: 'Just for you', price: 4500, image: 'just-for-you', category: 'Flowers', description: "The bouquet combines the delicate charm of astromeria, lilies and vibrant lollipop chrysanthemums, with gentle sprigs of baby's breath making it a thoughtful gift to brighten any occasion." },
  { id: '44', name: 'Cherry wonder', price: 4200, image: 'cherry-wonder', category: 'Flowers', description: "Cherry wonder comprises of an interplay of white, orange and lavender hues that create an understated elegance that conveys warmth and genuine affection." },
  ...
  { id: '46', name: 'Tropical mix', price: 5000, image: 'tropical-mix', category: 'Flowers', description: "Surprise someone with an enchanting bouquet of lilies, astromeria, yellow and white chrysanthemums. Make them feel special and valued." },
  { id: '47', name: 'Birthday wish', price: 4000, image: 'birthday-wish', category: 'Gifts', description: "Make their birthday memorable with this enchanting package of a red roses bouquet with a touch of baby's breath, Cadbury chocolate and a message card." },
  { id: '48', name: 'Love at home', price: 4500, image: 'love-at-home', category: 'Flowers', description: "50 stems of radiant red roses, hand-selected for their beauty and freshness; the bouquet speaks volumes of affection." },
  { id: '49', name: 'Heart box', price: 4999, image: 'heart-box-red-pink', category: 'Flowers', description: "Heart box filled with red and baby pink roses, perfect for office buddies or romantic surprises." },
  { id: '50', name: 'Sunkissed boquet', price: 3700, image: 'sunkissed-bouquet-new', category: 'Flowers', description: "White and yellow roses with a touch of gypsum, perfect for brightening up someone's day." },
  { id: '51', name: 'Lush boquet', price: 2500, image: 'lush-bouquet', category: 'Flowers', description: "Lush is a standard bouquet enchanted with pink, white and red roses perfect for any special occasion." },
  { id: '52', name: 'Lindor flat boquet', price: 6000, image: 'lindor-flat-bouquet', category: 'Gifts', description: "Lindor flat bouquet is a mix of roses and tropicals accompanied with Lindt chocolate. The bouquet conveys warmth and genuine affection." },
  { id: '53', name: 'Tropical boquet', price: 2500, image: 'tropical-bouquet-new', category: 'Flowers', description: "A vibrant mixture of chrysanthemums and astromeria, perfect for any occasion." }
];
