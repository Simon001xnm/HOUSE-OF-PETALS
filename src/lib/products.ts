...
export const ALL_PRODUCTS: Product[] = [
  ...
  { id: '42', name: 'Pure sweetness', price: 6500, image: 'pure-sweetness', category: 'Gifts', description: "red roses and baby's breath , accompanied with 8 piece Ferrero rotcher chocolate perfect for expressing deep love and affection." },
  { id: '43', name: 'Just for you', price: 4500, image: 'just-for-you', category: 'Flowers', description: "the boquet combines the delicate charm charm of astromeria, lilies and vibrant lollipop chrysanthemums, with gentle springs of baby's breath making it thoughtful gift to brighten any occasion." },
  ...
  { id: '53', name: 'Tropical boquet', price: 2500, image: 'tropical-bouquet-new', category: 'Flowers', description: "a mixture of chrysanthemums and astromeria perfect for any occasion" }
];
